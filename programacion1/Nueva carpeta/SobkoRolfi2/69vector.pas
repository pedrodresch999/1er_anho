...
begin
	...
	for i:=1 to 10 do 														//se carga el vector
		begin 
			...
			readln(car[i].patente);
			writeln('ahora ingrese la marca del vehiculo ', i);
			readln(car[i].marca);
			writeln('ahora ingrese el modelo del vehiculo ', i);
			readln(car[i].modelo);
			writeln('ahora ingrese el anho del vehiculo ', i);
			readln(car[i].year);
		end;
